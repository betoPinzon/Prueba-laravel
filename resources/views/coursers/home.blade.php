    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div class="flex">
                ...
                <a href="{{route('coursers.create')}}" class="flex items-center font-narrow text-white text-lg bg-orange-500 rounded px-2 py-1.5 hover:bg-orange-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />
                    </svg>
                    <p class="ml-1">Crear Curso</p>
                </a>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @endif
                        ...
                        <table class="min-w-max w-full table-auto text-center">
                            ...
                            @foreach($coursers as $curso)
                                    <tr class="border-b border-gray-200 hover:bg-gray-200">
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <p>{{$curso->created_at->format('d M Y')}}</p>
                                        </td>
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <p>{{$curso->name}}</p>
                                        </td>
                                        ...
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            ...
                                            @else
                                                <p class="">{{ucfirst($curso->category->name)}}</p>
                                            @endif
                                        </td>
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center ">
                                                <a href="{{route('post',$curso->slug)}}" target="_blank" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
