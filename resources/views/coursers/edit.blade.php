                        ...
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="mt-5 md:col-span-2 md:mt-0">
                                <form id="courser_form"
                                      action="{{route('coursers.update',$courser)}}"
                                      method="POST"
                                            ...
                                            <div class="grid grid-cols-3 gap-6">
                                                <div class="col-span-6">
                                                    ...
                                                    <div class="flex items-center text-red-600">
                                                        ...
                                                        <p class="font-bold text-xs">{{'El título no puede quedar vació'}}</p>
                                                        @enderror
                                                    </div>
                                                    <input type="text" name="name" id="name" value="{{$courser->name}}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <textarea id="description" name="description" rows="12" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{$courser->description}}</textarea>
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div class="col-span-6 mt-5 sm:col-span-3">
                                                    ...
                                                    <select id="teacher_id" name="teacher_id" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                        ...
                                                        @foreach($teachers as $teacher)
                                                            @if($courser->teacher_id == $teacher->id)
                                                                <option value="{{$teacher->id}}" selected >{{ucfirst($teacher->firstname . " " . $teacher->lastname)}}</option>
                                                            @else
                                                ...
                                                <div class="col-span-6 mt-5 sm:col-span-3">
                                                    ...
                                                    <select id="category_id" name="category_id" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                        <option value="" selected disabled hidden>Escoger Categoria</option>
                                                        <option value="">Sin Asignar - Categoría</option>
                                                        @foreach($categories as $category)
                                                            @if($courser->category_id == $category->id)
